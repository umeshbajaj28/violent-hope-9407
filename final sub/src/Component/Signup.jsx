...
function Signup() {
  return (
    ...
    <Stack>
        ...
        <Heading marginLeft='10%' >Signup into TMetric</Heading>
        <Text marginLeft='10%'>Name</Text>
        <Input marginLeft='10%' type='filled' placeholder='Enter Name' size='lg' bg='white' color='black'  marginTop='2%'/>
    ...
    <Button bg='blue' color='white' marginTop='2%'> <Link to='/login'>Signup</Link></Button>
    </Stack>
</Box>
