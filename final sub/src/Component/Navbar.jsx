...
function Navbar() {
  return (
    <Box bg='white' w='100%' p={4} color='white' display='flex'>
...
Capture and control every task you work on
  ...
  <Box>
    <Button  bg='blue' color='white'> <Link to='/login'>Login</Link></Button>
    <Button bg='blue' color='white'> <Link to='/signup'>Signup</Link></Button>
  </Box>
